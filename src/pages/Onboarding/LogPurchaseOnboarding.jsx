...
import styles from "./LogPurchaseOnboarding.module.css";

function LogPurchaseOnboarding() {
  return (
    <div className={styles.page}>
      ...
      <div className={styles.card}>
        ...
        <LogPurchaseForm variant="onboarding" />
      </div>
    </div>
  );
}

export default LogPurchaseOnboarding;
